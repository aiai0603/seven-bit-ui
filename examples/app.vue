<template>
  <sb-back-top style="padding: 10px; width: 40px; height: 40px; display: flex; flex-flow: row; justify-content: center; align-items: center">
    <div style="text-align: center"> 返回首页 </div>
  </sb-back-top>
  <sb-layout>
    <sb-header style="background-color: skyblue">
    ...
    <sb-layout direction="horizontal">
      <sb-aside :width="we">
        <sb-button status="secondary" size="small" @click="testclose()" v-if="we == 200" style="padding: 0 10px"> <sb-icon name="left"></sb-icon> </sb-button>
        <sb-button status="secondary" size="small" @click="testopen()" v-else style="padding: 0 10px"> <sb-icon name="right"></sb-icon> </sb-button>
    ...
    <sb-footer :height="200" style="background-color: greenyellow"> Footer </sb-footer>
  </sb-layout>
</template>
