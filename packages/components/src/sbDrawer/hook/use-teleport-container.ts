...
export const on = (() => {
  ...
  return <K extends keyof HTMLElementEventMap>(element: HTMLElement | Window, event: K, handler: () => void, options: boolean | AddEventListenerOptions = false) => {
...
export const off = (() => {
  ...
  return <K extends keyof HTMLElementEventMap>(element: HTMLElement | Window, type: K, handler: () => void, options: boolean | EventListenerOptions = false) => {
...
export const useTeleportContainer = ({ popupContainer, visible, defaultContainer = 'body', documentContainer }: { popupContainer: Ref<string | HTMLElement | undefined>; visible: Ref<boolean>; defaultContainer?: string; documentContainer?: boolean }) => {
